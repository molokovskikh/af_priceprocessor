...
namespace PriceProcessor.Test.Waybills.Parser
{
	...
	public class SiaXmlParserFixture
	{
		...
		public void Parse_Ripharm()
		{
			...
			Assert.That(doc.Lines[0].ProducerCost, Is.EqualTo(102.23f));

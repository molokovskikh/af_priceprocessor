...
namespace PriceProcessor.Test.Waybills.Parser
{
	public class SiaKazanParserFixture
	{
		...
		public void Parse_SiaInternationalSpb()
		{
			...
			Assert.That(line.ProducerCostWithoutNDS, Is.EqualTo(199.1100));
			Assert.That(line.Nds, Is.EqualTo(10));
			...
			Assert.That(line.RegistryCost, Is.EqualTo(0));
			Assert.That(line.SupplierPriceMarkup, Is.EqualTo(5.84));
		...
		public void Parse_SiaInternational_Omsk()
		{
			...
			Assert.That(line.Quantity, Is.EqualTo(1.0000));
			Assert.That(line.ProducerCostWithoutNDS, Is.EqualTo(207.1800));

...
namespace PriceProcessor.Test.Waybills.Parser
{
	...
	public class Moron_338_SpecialParserFixture
	{
		...
		public void Parse()
		{
			...
			Assert.That(document.Lines[0].ProducerCostWithoutNDS, Is.EqualTo(29.02));
		...
		public void Parse_Sia_Orel_with_zhnvls()
		{
			...
			Assert.That(line.ProducerCostWithoutNDS, Is.EqualTo(42.3700));
		...
		[Test]
		public void Parse_document_without_price()
		{
			var documentLog = new DocumentReceiveLog { Supplier = new Supplier { Id = 21u } };
			var document = WaybillParser.Parse(@"..\..\Data\Waybills\р-1690677.dbf", documentLog);
			Assert.That(document.Lines[1].SupplierCostWithoutNDS, Is.Null);
		}
	}
}
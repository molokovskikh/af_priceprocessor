...
namespace PriceProcessor.Test.Waybills.Parser
{
	...
	public class AptekaHoldingIzhevskParserFixture
	{
		...
		{
			Assert.IsFalse(AptekaHoldingIzhevskParser.CheckFileFormat(@"..\..\Data\Waybills\1016416.dbf"));
			Assert.IsFalse(AptekaHoldingIzhevskParser.CheckFileFormat(@"..\..\Data\Waybills\1016416_char.DBF"));
			Assert.IsFalse(AptekaHoldingIzhevskParser.CheckFileFormat(@"..\..\Data\Waybills\0000470553.dbf"));
			Assert.IsFalse(AptekaHoldingIzhevskParser.CheckFileFormat(@"..\..\Data\Waybills\1040150.DBF"));
			Assert.IsFalse(AptekaHoldingIzhevskParser.CheckFileFormat(@"..\..\Data\Waybills\8916.dbf"));
			Assert.IsFalse(AptekaHoldingIzhevskParser.CheckFileFormat(@"..\..\Data\Waybills\R1362131.DBF"));
			Assert.IsTrue(AptekaHoldingIzhevskParser.CheckFileFormat(@"..\..\Data\Waybills\396559.DBF"));
		}
	}
}

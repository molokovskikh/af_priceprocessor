	...
	public class LekRusChernozemieSpecialParser : IDocumentParser
	{
		...
		public Document Parse(string file, Document document)
		{
			...
			new DbfParser()
				...
				.Invoice(i => i.RecipientAddress, "ADRESS_G")
				.Invoice(i => i.ShipperInfo, "ADRESS_P")
				.Invoice(i => i.AmountWithoutNDS0, "SUMBNDS0")
				.Invoice(i => i.AmountWithoutNDS10, "SUMBNDS10")
				.Invoice(i => i.AmountWithoutNDS18, "SUMBNDS18")
				.Invoice(i => i.NDSAmount10, "SUMNDS10")
				.Invoice(i => i.NDSAmount18, "SUMNDS18")
				.Invoice(i => i.Amount10, "SUMSNDS10")
				.Invoice(i => i.Amount18, "SUMSNDS18")
				.Invoice(i => i.AmountWithoutNDS, "SUMBNDS")
				.Invoice(i => i.Amount, "SUMALL")

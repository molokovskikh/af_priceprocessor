	...
	public class SiaPermParser : IDocumentParser
	{
		...
		public Document Parse(string file, Document document)
		{
			...
			document.Lines = data.Rows.Cast<DataRow>().Select(r => {
				...
				line.ProducerCostWithoutNDS = Convert.IsDBNull(r["PROCENA"]) ? null : (decimal?)Convert.ToDecimal(r["PROCENA"], CultureInfo.InvariantCulture);
				...
				line.NdsAmount = Convert.ToDecimal(r["SUM_NDS"], CultureInfo.InvariantCulture);

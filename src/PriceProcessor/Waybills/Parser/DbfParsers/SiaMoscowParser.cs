...
{
	public class SiaMoscowParser : BaseDbfParser2
	{
		public override DbfParser GetParser()
		{
			return new DbfParser()
				...
				.Line(l => l.OrderId, "O_NUM");
		}

		public static bool CheckFileFormat(DataTable data)
		{
			var CodeIndex = data.Columns.Contains("SP_PRD_ID");
			...
			var numIndex = data.Columns.Contains("O_NUM");

			if (!CodeIndex || !ProductIndex || !numIndex)
				return false;

				...
				else
				{
					...
					do
					{
						...
						try
						{
							...
							//Формируем таблицу Core для всех ценовых колонок мультиколоночного прайса
#region Create Core
							...
							//            //Вставляем только для цен, которые не базовые, чтобы не было дубликата базового прайса
							//            if (c.costCode != priceCode)
							//            {
							//                //Если не нулевая цена, что производим вставку записи

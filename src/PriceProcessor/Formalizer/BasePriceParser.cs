...
namespace Inforoom.Formalizer
{
	...
	public abstract class BasePriceParser
	{
		...
		// Временный флажок
		// если true, тогда при парсинге проверяем, если разбираемый priceItemId
		// находится в списке, тогда заменяем кавычки с помощью регулярного выражения 
		// (это нужно для файлов, которые были сконвертированы из XLS в TXT)

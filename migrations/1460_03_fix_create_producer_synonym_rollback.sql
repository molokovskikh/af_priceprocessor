...
BEGIN
	...
	set LastProducerSynonymId = (select SynonymFirmCrCode from farm.SynonymFirmCr ps where ps.Synonym = Synonym and s.CodeFirmCr <=> ProducerId and ps.PriceCode=PriceId limit 1);
